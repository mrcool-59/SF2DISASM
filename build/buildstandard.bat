...
cd ../musicbankext2-standard/
echo Assembling music bank ext 2 ...
    ..\..\..\..\tools\asw\asw.exe .\musicbankext2.asm
    ..\..\..\..\tools\asw\p2bin.exe .\musicbankext2.p ..\musicbankext2.bin -k -r $8000-$ffff
cd ../sfxbank-standard/
